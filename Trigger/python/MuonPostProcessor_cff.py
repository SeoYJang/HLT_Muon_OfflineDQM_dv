...
"Refefficiency_Eta_Mu2 'Reference efficiency; Eta; N(pass) / N' Refefficiency_Eta_Mu2_numer Refefficiency_Eta_Mu2_denom",
    ...
    #    "offlineMuonPt ';p_{T};' offlineMuonPt",
    #    "offlineMuonEta ';#eta;' offlineMuonEta",
    #    "offlineMuonPhi ';#phi;' offlineMuonPhi",
    #)
...
hltMuonEfficienciesTnP = DQMEDHarvester("DQMGenericClient",
    ...
    efficiencyProfile = cms.untracked.vstring(
        ...
        "efficiencyEtatnp 'Efficiency to Match Probe Muons to Trigger Objects; #eta^{reco}; N(#mu matched to trigger object) / N(#mu)' efficiencyEtatnp_numer efficiencyEtatnp_denom",
        "efficiencyPttnp 'Efficiency to Match Probe Muons to Trigger Objects; p_{T}^{reco}; N(#mu matched to trigger object) / N(#mu)' efficiencyPttnp_numer efficiencyPttnp_denom",
        "efficiencyPtTag 'Efficiency to Match Tag Muons to Offline Muons; p_{T}^{reco}; N(#mu matched to trigger object) / N(#mu)' efficiencyPtTag_numer efficiencyPtTag_denom",
    ),
)
